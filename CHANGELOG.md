...
- ✅ **The censuses follow the repair, each movement with one cause:** writes **39/30 → 26/17** (thirteen routes left in a single step), reads **40 site-global tables → 29**. 13 rows left and 0 joined; 9 tables left and 0 joined.
