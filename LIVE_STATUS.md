...
| Phase 1 — trustworthy LAN vertical slice | In Progress | opened by the ADR-002 signature; `.1` decomposed into `.1.1.1`–`.1.1.3` and **all three done**; `.1.2` decomposed (gap-census-first) into `.1.2.1`–`.1.2.3` — frontier `.1.2.1` (dev-profile node enrollment) |
