...
| Phase 1 — trustworthy LAN vertical slice | In Progress | opened by the ADR-002 signature; `.1` decomposed into `.1.1.1`–`.1.1.3`; **`.1.1.1` aggregate library done** (ADR-004); **`.1.1.2` identity store done** (migration 0007); frontier `.1.1.3` (thread command API completion) |
