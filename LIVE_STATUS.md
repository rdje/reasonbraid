...
| Phase 1 — trustworthy LAN vertical slice | In Progress | opened by the ADR-002 signature; `.1` decomposed into `.1.1.1` (aggregate/event/outbox library), `.1.1.2` (migration 0007 identity store), `.1.1.3` (thread command API completion) — frontier `.1.1.1` |
