...
- latest_commit: `REASONBRAID-REPAIR-0222` (leaf `SIGNOFF-REPAIR.11.14.3.8`): the standalone assessment route is bound to the citing tenant. Re-derive the ahead-of-origin count with `git rev-list --count origin/main..HEAD`; push at ~300.
