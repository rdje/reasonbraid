...
- **Active tree:** `PHASE-5` → frontier `.4` (**PHASE 4 CLOSED**;
...
- **Next action:** execute `PHASE-5.4` — the versioned
  evaluation service (§13.7, §19.5, ADR-017, backlog 37): the
  hypothesis case set, the randomized routing experiments,
  the cohort tracking, the calibration, the regression gates.
  Decompose at the census seams first (the `.3` lane
  COMPLETE).
