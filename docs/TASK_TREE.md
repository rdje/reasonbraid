...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.2` — tenant guard primitives after the committed path census/design; actual-parent selection and inspection provenance/readback complete | repo-local |
