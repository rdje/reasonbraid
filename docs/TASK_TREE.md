...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.13` — guard coverage reconciliation and qualification: repeat the full census now that `.8`–`.12.1` have landed | repo-local |
