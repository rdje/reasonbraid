...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.8` — repair participant-removal authority, then retention fixture clock, remaining cleanup plans and full checkpoint | repo-local |
