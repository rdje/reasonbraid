...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.7.4` — adopt remaining five cleanup plans and reconcile regression coverage before full checkpoint | repo-local |
