...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.1.2` — the visibility + the remote recruitment (opened at the Phase-7 close; `.1` done: the census → decomposed; `.1.1` done: ADR-026 accepted) | repo-local |
