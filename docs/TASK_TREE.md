...
| [`PHASE-7`](tasks/PHASE-7.md) | `active` | `.1.1` — ADR-034 + the census (the `.1` lane decomposed: the mTLS identity → the isolation + the quotas → the secrets + the regions) | repo-local |
