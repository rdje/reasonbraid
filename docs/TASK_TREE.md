...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.3` — integrate authority writers after qualified guard/connection ownership and migration delivery | repo-local |
