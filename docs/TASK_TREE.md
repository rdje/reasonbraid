...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.1.4` — the cross-domain audit receipts (opened at the Phase-7 close; `.1` done: the census → decomposed; `.1.1` ADR-026; `.1.2` the agreement machinery; `.1.3` the portable cards) | repo-local |
