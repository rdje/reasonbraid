...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.2` — explicit site-operator registry authority; tenant-bound revocation and disposable verification complete | repo-local |
