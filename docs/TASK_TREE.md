...
| [`PHASE-6`](tasks/PHASE-6.md) | `active` | `.4.2` — the publication records + the staging (`.4.1` done: ADR-020 accepted — the nine-step machine + the CAS idempotency) | repo-local |
