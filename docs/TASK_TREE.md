...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.3.3.3.3.2` — persist CLI bootstrap identity and bound HTTP recovery after qualified writer integration | repo-local |
