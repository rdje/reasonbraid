...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.2` — bound authority evaluation, then actual-parent selection and atomic tenant effect audit; core subject and site registry repairs complete | repo-local |
