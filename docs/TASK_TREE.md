...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2` — resume full checkpoint after qualified history repair; public push is authorized after gates | repo-local |
