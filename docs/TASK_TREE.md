...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.7.3.3.2` — production input interference reproduced; qualify direct-worker completion before exclusive input/digest integration and checkpoint | repo-local |
