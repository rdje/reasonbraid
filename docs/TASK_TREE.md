...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.5.2` — own production browser profile/process/tasks; then combined qualification, cleanup/full checkpoint and bounded CLI transport | repo-local |
