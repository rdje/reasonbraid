...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.3` — the MCP lane (opened at the Phase-7 close; **the `.1` lane COMPLETE**; **the `.2` lane COMPLETE**: ADR-025, the pin, the facade, the wire demonstration) | repo-local |
