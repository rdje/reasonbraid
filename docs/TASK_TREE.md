...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.4.3` — cached-decision freshness and the future clock; `.3.4.1` corrected its own parent's census and `.3.4.2` bound the idempotency hash to the authority context | repo-local |
