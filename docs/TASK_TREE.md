...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.5.2` — the metrics surface outlives the boundary that authorized it; `.3.5` censused the tenant-administration surface, found its third finding already closed by `.3.3.4.10`, and split | repo-local |
