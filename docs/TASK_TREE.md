...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.2.2` — protected operator CLI, then HTTP enforcement; site service, tenant-bound revocation and disposable verification complete | repo-local |
