...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.4` — delegation bounds and cached-decision freshness; `.3.3.4` closed at `.13`, which certified eighteen guarded routes and named the owner of every one of the 46 mutating routes it does not certify | repo-local |
