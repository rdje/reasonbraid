...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.10.3` — node inbox administration: replay, quarantine and prune onto the guarded effect transaction | repo-local |
