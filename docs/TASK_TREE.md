...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.4.2.6` — the bad-proof control refuses before it reaches the signature, a prerequisite for the proof-replay leaf; `.4.2.1` closed the rotation/revocation ordering | repo-local |
