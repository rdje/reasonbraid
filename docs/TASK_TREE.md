...
| [`PHASE-1`](tasks/PHASE-1.md) | `active` | `.1.4.1` — the Claude CLI adapter core (`.1.4` decomposed at the code-vs-live seam; `.1.3` invitation/subscription semantics complete) | repo-local |
