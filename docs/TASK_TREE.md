...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2` — explicit state-lock release qualified; resume full checkpoint before public push/remote CI | repo-local |
