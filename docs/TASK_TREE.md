...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.5.3` — qualify combined browser lifetime; then cleanup/full checkpoint and bounded CLI transport | repo-local |
