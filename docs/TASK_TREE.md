...
| [`PHASE-4`](tasks/PHASE-4.md) | `active` | `.3` — pack R1: public Git acquisition (the `.2` lane — pack R0 — is COMPLETE: the classifier, the fetcher, the receipt, the wiring) | repo-local |
