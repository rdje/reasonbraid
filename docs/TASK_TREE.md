...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.7.3.3.5` — the R2 pack advertises five media types its own acquisition leg refuses; census per format, then the decision | repo-local |
