...
| [`PHASE-1`](tasks/PHASE-1.md) | `active` | `.1.7` — local/LAN deployment packaging (`.1.6` complete: budget read + embedded shell + demo beat; `MAINT-1`…`MAINT-3` closed) | repo-local |
