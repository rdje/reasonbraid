...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3` — core subject serialization, actual-boundary authorization and atomic tenant effect auditing; site registry repair complete | repo-local |
