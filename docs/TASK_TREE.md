...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.7.2` — migrate checked node-fixture plans, then remaining fixture qualification and full checkpoint | repo-local |
