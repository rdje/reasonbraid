...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.12.1` — the card import's both-tenant guard set: `.12` closed the importing side of the revocation race and left the origin side open | repo-local |
