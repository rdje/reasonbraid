...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.10` — node administrative transactions: split token issuance, certificate revocation and inbox mutation into children before implementing | repo-local |
