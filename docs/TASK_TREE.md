...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.7` — close remaining fixture dependencies, then full checkpoint and authorized public push/remote CI | repo-local |
