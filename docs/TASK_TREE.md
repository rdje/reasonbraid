...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.11.2` — guarded owner attestation in one transaction, with its read-modify-write under the role/version anchor lock `.11.1` landed | repo-local |
