...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.2.3` — the blind-first lane (`.2.2` done: the structured records — the server-computed digests + the digest-targeted objection) | repo-local |
