...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.2.1` — ADR-029 + the census (the `.2` lane decomposed: the blind-first visibility, the structured records, the evidence requests, the adjudication + the minority reports + the terminals) | repo-local |
