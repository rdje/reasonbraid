...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.5` — pin/bind the dedicated browser runtime, then resume full checkpoint and authorized public push | repo-local |
