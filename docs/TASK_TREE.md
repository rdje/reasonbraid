...
| [`PHASE-4`](tasks/PHASE-4.md) | `active` | `.4` — pack R2: sandboxed document extraction (packs R0 + R1 COMPLETE: the classifier/fetcher/receipt/wiring lanes `.2` + `.3`) | repo-local |
