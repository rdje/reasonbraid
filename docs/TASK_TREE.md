...
| [`PHASE-2`](tasks/PHASE-2.md) | `active` | `.1.4` — the delegated authority context (`.1.3` complete: node/cert + grant + boundary revocation, all riding the existing refusal ladders; then `.1.5` caching → `.1.6` incarnations) | repo-local |
