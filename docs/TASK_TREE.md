...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.3.2.2.1` — provenance implementation committed with final upgrade confirmation pending; consume and close before HTTP inspection receipts | repo-local |
