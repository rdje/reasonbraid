...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.7.3.3` — extraction fixtures qualified; repair production input ownership before full checkpoint/public push | repo-local |
