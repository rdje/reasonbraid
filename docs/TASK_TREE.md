...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.2.4` — the evidence requests + the adjudication + the minority reports (`.2.3` done: the blind-first lane — the round-advance commitment) | repo-local |
