...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.7.3.3.2.2` — director-requested handoff; resume the preserved direct-worker completion plan before input integration and checkpoint | repo-local |
