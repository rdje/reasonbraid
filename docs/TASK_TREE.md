...
| [`PHASE-6`](tasks/PHASE-6.md) | `active` | `.4.3` — the Git publication + the reconciliation (`.4.2` done: the publication records — the aggregate + the state machine) | repo-local |
