...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.3.3` — wire verified CI launchers and complete script/worker/demo coverage; finish checkpoint prerequisites/gates, then bounded CLI transport | repo-local |
