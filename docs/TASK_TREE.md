...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.5` — the routing-policy lane (the `.4` lane COMPLETE: the evaluation service — the registry, the runs, the trials, the calibration, the gates) | repo-local |
