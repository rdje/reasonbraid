...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2` — resume full checkpoint with the pinned browser, then authorized public push and remote CI | repo-local |
