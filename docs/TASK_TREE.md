...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.3` — the moderator/synthesizer lane (the `.2` lane COMPLETE: the blind-first deliberation — the structured records, the blind commitment, the requests + the adjudication, the twelve terminals) | repo-local |
