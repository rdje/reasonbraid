...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.3.2` — frozen-admin read authority, then atomic tenant effect audit; command candidate selection, changelog rotation and bound evaluation complete | repo-local |
