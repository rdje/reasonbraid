...
| [`PHASE-7`](tasks/PHASE-7.md) | `active` | `.4.2` — the §18.6 runbook set (the `.1`/`.2` lanes COMPLETE; `.3` done; `.4` done: the census → decomposed; `.4.1` done: the load harness — the measured run) | repo-local |
