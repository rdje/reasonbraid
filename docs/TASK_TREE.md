...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.3.2.2.2` — audited HTTP inspection receipts, then scoped readback; provenance, strict selector decoding and upgrade qualification complete | repo-local |
