...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.2.3` — the A2A facade (opened at the Phase-7 close; the `.1` lane COMPLETE; `.2` done: the census → decomposed; `.2.1` ADR-025; `.2.2` the pin decision) | repo-local |
