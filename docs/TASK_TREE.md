...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.2.3` — HTTP registry enforcement; site service/operator CLI, tenant-bound revocation and disposable verification complete | repo-local |
