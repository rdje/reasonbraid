...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.11.2` — repair reproduced inherited state-lock retention, then resume full checkpoint/public push/remote CI | repo-local |
