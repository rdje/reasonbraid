...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.3.3.3.3.2.3.1` — completion-capacity reproduction and pre-dispatch repair after keyed CLI qualification | repo-local |
