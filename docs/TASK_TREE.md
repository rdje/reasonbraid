...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.5` — qualify browser profile/process lifetime; finish cleanup/full checkpoint, then bounded CLI transport | repo-local |
