...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.8` — the first producer of an effect record: one guarded revocation transaction carrying admission, reason and final effect | repo-local |
