...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.5.2` — a LOCKSTEP box may not claim a document the commit does not touch; the census is done, the gate is not written | repo-local |
