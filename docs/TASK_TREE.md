...
| [`PHASE-1`](tasks/PHASE-1.md) | `active` | `.1.4` — the second genuinely distinct harness adapter (Claude-family; `.1.3` invitation/subscription semantics complete) | repo-local |
