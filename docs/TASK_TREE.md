...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.6` — safely dispose of compiler artifacts; then full checkpoint and bounded CLI transport | repo-local |
