...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.3` — repair CI locality/script coverage after inventory; finish checkpoint prerequisites/gates, then bounded CLI transport | repo-local |
