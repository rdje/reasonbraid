...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.3.3.3.3.2.2` — integrate keyed CLI enrollment and explicit recovery after qualified state schema | repo-local |
