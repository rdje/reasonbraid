...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.4.4` — census the remaining tagged authority codecs; `.3.4.1.1` made a delegation without a scope unwritable, and found two fixtures that had been constructing that state | repo-local |
