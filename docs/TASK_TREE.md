...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.5.2` — the rule-based policy (`.5.1` done: ADR-031 accepted — the deterministic table, the explicit profile outranks it) | repo-local |
