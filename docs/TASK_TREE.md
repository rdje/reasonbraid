...
| [`PHASE-1`](tasks/PHASE-1.md) | `active` | `.1.3.1` — invitation lifecycle in the thread state machine (`.1.3` decomposed: invite→pending, accept/decline/expire/remove, dispatch-on-accept, join/subscriptions) | repo-local |
