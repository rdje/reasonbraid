...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.5.3` — the tree index's frontier column drifted; census the rows, then generate the column rather than check it | repo-local |
