...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.4.1` — node enrollment and certificate lifecycle; `.11.6` measured its own pattern at 4 of 8 gates and promoted a method statement rather than a gate, partly refuting itself | repo-local |
