...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4` — tenant authority/effect serialization and final audit; actual-parent selection, frozen reads, provenance and scoped receipt readback complete | repo-local |
