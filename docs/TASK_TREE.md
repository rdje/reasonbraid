...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.5` — tenant-owned administration; `.3.4.3.1.3` reproduced a certificate that rotated five minutes AFTER it expired, closing the clock family | repo-local |
