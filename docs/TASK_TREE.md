...
| [`PHASE-2`](tasks/PHASE-2.md) | `active` | `.1.5` — the cached-decision semantics (`.1.4` complete: the delegated authority context rides the envelope + the dual evaluation; then `.1.6` incarnations) | repo-local |
