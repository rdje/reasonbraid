...
| [`PHASE-7`](tasks/PHASE-7.md) | `active` | `.2.2` — the disclosure + the supported-version policy (the `.1` lane COMPLETE; `.2` done: the census → decomposed; `.2.1` done: ADR-027 accepted) | repo-local |
