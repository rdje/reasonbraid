...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.10.2` — node certificate revocation onto the guarded effect transaction, with its reason persisted | repo-local |
