...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.11` — profile/card administration: split the common transaction body, guarded attestation and atomic import into children before implementing | repo-local |
