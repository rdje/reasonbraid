...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.6` — whether "measure the population before proposing the rule" generalises; `.11.8` censused the routes against the book (103 product routes, 22 described, 80 absent) after its instrument undercounted by 42 % | repo-local |
