...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.7.3.3.4.2` — prove the R2 mismatch refusal persists nothing, live; the `.4.1` seam and origin are reused | repo-local |
