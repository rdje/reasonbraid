...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.2.4` — the A2A compatibility demonstration (opened at the Phase-7 close; the `.1` lane COMPLETE; `.2` done: the census → decomposed; `.2.1` ADR-025; `.2.2` the pin; `.2.3` the facade core) | repo-local |
