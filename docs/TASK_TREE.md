...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.4.2.2` — the handshake and rotate proofs are replayable and each rotate replay returns a fresh private key; its prerequisite proof ladder now exists (`.4.2.6`) | repo-local |
