...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.3` — actual-parent/usable-grant selection, then atomic tenant effect audit; bound evaluation, core subject and site registry repairs complete | repo-local |
