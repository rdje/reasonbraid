...
| [`PHASE-6`](tasks/PHASE-6.md) | `active` | `.4.1` — ADR-020 + the census (the `.4` lane decomposed: the records + the staging → the Git publication + the reconciliation) | repo-local |
