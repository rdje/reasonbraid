...
| [`PHASE-2`](tasks/PHASE-2.md) | `active` | `.3` — provider-attempt state machine + usage reconciliation (**`.2` complete**: ADR-005, the lease epoch, the retry policy, the two-way quarantine) | repo-local |
