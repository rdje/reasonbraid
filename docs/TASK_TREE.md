...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.3.2` — the moderation kinds (`.3.1` done: ADR-030 accepted — the closed vocabulary is the prohibition, the `moderate` step joins the vocabulary) | repo-local |
