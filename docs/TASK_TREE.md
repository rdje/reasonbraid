...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2.3` — director decision on confirmed public remote/private-policy conflict; then history repair and full checkpoint | repo-local |
