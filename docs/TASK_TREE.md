...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.2` — all 25 fixture plans qualified; resume full checkpoint before public push and remote CI | repo-local |
