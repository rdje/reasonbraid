...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.3.2` — scanner integrity/pinning after shared CI environment, then workflow wiring; finish checkpoint prerequisites/gates, then bounded CLI transport | repo-local |
