...
| [`PHASE-6`](tasks/PHASE-6.md) | `active` | `.4.3.1` — the publication-store contract (the `.4.3` half decomposed: the store → the Git publication → the reconciliation) | repo-local |
