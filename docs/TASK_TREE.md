...
| [`PHASE-2`](tasks/PHASE-2.md) | `active` | `.1.1` — the ADR-006/007 identity-issuance spike (`.1` decomposed at the census seams: cert lifecycle → revocation → delegation → caching → incarnations) | repo-local |
