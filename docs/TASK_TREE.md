...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.5.2.1` — the metrics read is unaudited; `.3.5.2` closed a revoked boundary that had left the metrics surface open, reproduced against the live route first | repo-local |
