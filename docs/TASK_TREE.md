...
| [`PHASE-7`](tasks/PHASE-7.md) | `active` | `.5` — the G6–G7 exit for a named capability profile (the `.1`/`.2`/`.4` lanes COMPLETE; `.3` done; the game-day + the pen-test stance ship) | repo-local |
