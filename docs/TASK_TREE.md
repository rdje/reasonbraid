...
| [`PHASE-7`](tasks/PHASE-7.md) | `active` | `.2.3` — the SBOM + the signed release artifacts (the `.1` lane COMPLETE; `.2` done: the census → decomposed; `.2.1` done: ADR-027; `.2.2` done: the SECURITY.md policy) | repo-local |
