...
| [`PHASE-4`](tasks/PHASE-4.md) | `active` | `.2.3` — the snapshot receipt + the R0 pack wiring (`.2.2` done: the safe HTTPS fetcher — the SSRF proof measured; `PHASE-4-MAINT-1` done: the clippy evidence debt repaired) | repo-local |
