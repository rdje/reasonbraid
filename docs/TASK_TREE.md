...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.3.2.2` — explicit inspection audit provenance, then atomic tenant effect audit; frozen-read eligibility and command selection complete | repo-local |
