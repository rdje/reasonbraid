...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.3.2.2.3` — scoped receipt readback; seven HTTP inspection receipt producers, provenance, strict decoding and upgrade qualification complete | repo-local |
