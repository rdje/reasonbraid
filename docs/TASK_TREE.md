...
| [`PHASE-7`](tasks/PHASE-7.md) | `active` | `.1.4.2` — the secret-store declared profiles (`.1.1` done: ADR-034; `.1.2` done: the mTLS identity; the `.1.3` lane COMPLETE; `.1.4` done: the census → decomposed; `.1.4.1` done: the declared-profile contract) | repo-local |
