...
| [`PHASE-2`](tasks/PHASE-2.md) | `active` | `.2` — production-grade leases/fencing + retry + dead-letter (**`.1` complete**: cert lifecycle, revocation, delegation, cached decisions, incarnation/run writers) | repo-local |
