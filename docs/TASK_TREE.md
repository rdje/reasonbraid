...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.2.2` — the A2A dependency pin (opened at the Phase-7 close; the `.1` lane COMPLETE; `.2` done: the census → decomposed; `.2.1` done: ADR-025 accepted) | repo-local |
