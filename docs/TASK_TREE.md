...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.5.1` — the census + ADR-035 (opened at the Phase-7 close; **the `.1`–`.4` lanes COMPLETE**; `.5` the regional-routing census → decomposed `.5.1`–`.5.4`) | repo-local |
