...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.11.4.3.1.4` — qualify exclusive publisher fixtures; finish browser/cleanup prerequisites and full checkpoint, then bounded CLI transport | repo-local |
