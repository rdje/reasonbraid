...
| [`PHASE-4`](tasks/PHASE-4.md) | `active` | `PHASE-4-MAINT-1` — the clippy evidence debt repair (`.2.2` done: the safe HTTPS fetcher — the SSRF proof measured; 9 pre-existing `-D warnings` findings routed) → then `.2.3` | repo-local |
