...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.11.4` — the profile and card book chapter, opened by `.11.1` from a measured gap and now unblocked: `.11.1`–`.11.3` have settled the family's wire | repo-local |
