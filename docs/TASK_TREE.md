...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.3.3.4.11.3` — atomic card import: identity, grant, quota, enrollment, receipt AND the profile in one guarded transaction | repo-local |
