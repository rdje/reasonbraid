...
| [`SIGNOFF-REPAIR`](tasks/SIGNOFF-REPAIR.md) | `active` | `.7.3.3.5.2` — admit the ranked pack's advertised media types at the acquisition leg; the census and the decision are done | repo-local |
