...
| [`PHASE-8`](tasks/PHASE-8.md) | `active` | `.2` — the A2A interoperability (opened at the Phase-7 close; **the `.1` lane COMPLETE**: ADR-026, the agreement machinery, the portable cards, the cross-domain receipts) | repo-local |
