...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.2.2` — the structured records (`.2.1` done: ADR-029 accepted — the typed claim/objection/revision shapes over the verbs, the blind read-surface commitment, the twelve terminals) | repo-local |
