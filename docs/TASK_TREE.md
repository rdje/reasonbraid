...
| [`PHASE-5`](tasks/PHASE-5.md) | `active` | `.2.4.1` — the close vocabulary (the `.2.4` leaf decomposed: the twelve terminals + the minority report → then the contribution-side kinds) | repo-local |
