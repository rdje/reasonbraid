...
The current frontier is `SIGNOFF-REPAIR.3.2`: explicit site-operator registry
authority. Tenant-bound revocation is corrected with 34 focused tests and strict
lint. The disposable runner and test-side connection ownership proof are complete,
