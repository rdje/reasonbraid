...
| R-SECRET | Secret appears in prompt/log/event/artifact | WP4/WP5: credentials never enter events/fixtures | unresolved secret flow | security | open (latest full-history scan has two redacted findings; repair owner SIGNOFF-REPAIR.11.4.3.1.2.2) |
