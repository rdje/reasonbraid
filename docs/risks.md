...
| R-SECRET | Secret appears in prompt/log/event/artifact | WP4/WP5: credentials never enter events/fixtures | unresolved secret flow | security | open (continuous: `make secret-scan` green) |
