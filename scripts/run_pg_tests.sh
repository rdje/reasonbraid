...
cargo test -p reasonbraid-server --test atomic_transaction --test outbox_worker --test node_channel --test authority --test budget --test command_api --test node_work --test aggregate_library --test identity_store --test node_enrollment --test node_inbox --test invitations -- --nocapture
